...
`)
	...
	// Resolve the lines we expect to fire on by re-scanning manually.
...
// findFuncDecl is a small test helper that returns a top-level function
// declaration by name. Used by skip-test fixtures to locate skip-call lines
