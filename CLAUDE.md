...
5. Installed `.claude/skills/` and `.goat-flow/skill-docs/` references.
...
| Claude skills/config | `.claude/skills/`, `.claude/settings.json`, `.goat-flow/hooks/` |
