...
| Binary | `gruff-go` |
| Rule catalogue | 73 rules across 11 pillars; 64 enabled by default |
...
The current checkout contains 73 rules across 11 pillars. 64 rules are enabled by default; the 9 opt-in rules are convention-only naming/modernisation checks plus parser-only dead-code candidates.
