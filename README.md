...
| Binary | `gruff-go` |
| Rule catalogue | 63 rules across 11 pillars; 57 enabled by default |
...
The current checkout contains 63 rules across 11 pillars. 57 rules are enabled by default; the 6 opt-in rules are convention-only naming and modernisation checks.
