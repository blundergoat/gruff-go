...
| Binary | `gruff-go` |
| Rule catalogue | 51 rules across 11 pillars; 51 enabled by default |
...
The current checkout contains 51 rules across 11 pillars. All 51 rules are enabled by default.
