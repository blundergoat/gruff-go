...
Project configuration that tunes discovery, allowlists, rule selection, and per-rule thresholds/severity. Shared keys are `paths.ignore`, `allowlists.acceptedAbbreviations`, `selection`, and `rules.<id>`.
