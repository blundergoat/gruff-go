...
- "Write ADR-NNN" task: `ls .goat-flow/learning-loop/decisions/ADR-NNN-*` before drafting. Cheaper to discover the existing draft than to overwrite it.
