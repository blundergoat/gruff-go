...
1. `internal/source` expands input paths relative to the working directory, classifies Go and text/config files, and skips VCS directories, dependency caches, generated Go files, GOAT Flow task/log/scratchpad directories, and local tooling directories by default.
