...
<script id="gruff-dashboard-meta" type="application/json">
  {"type":"gruff-scan-complete","exitCode":0,"durationMs":245,"projectRoot":"/repo","command":"gruff-go analyse --format html --fail-on advisory ."}
</script>
