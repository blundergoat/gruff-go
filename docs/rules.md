...
| [`security.github-actions-secrets-in-pr`](#securitygithub-actions-secrets-in-pr) | security | advisory | parser | - | pull_request_target workflows referencing a named secret other than GITHUB_TOKEN. |
