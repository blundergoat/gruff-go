  ...
  scan:
    ...
    steps:
      ...
      - name: Install gruff-go
        run: go install github.com/blundergoat/gruff-go/cmd/gruff-go@v1.0.0
...
gruff-go:
  ...
  stage: test
  script:
    - go install github.com/blundergoat/gruff-go/cmd/gruff-go@v1.0.0
...
jobs:
  gruff-go:
    ...
    steps:
      ...
      - run:
          name: Install gruff-go
          command: go install github.com/blundergoat/gruff-go/cmd/gruff-go@v1.0.0
      - run:
          name: Scan
...
pipeline {
    ...
    stages {
        stage('gruff-go') {
            steps {
                sh 'go install github.com/blundergoat/gruff-go/cmd/gruff-go@v1.0.0'
